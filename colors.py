def dracula() -> tuple[list[list[str]], str, str, str, str]:
    colors = [
...
def everforest() -> tuple[list[list[str]], str, str, str, str]:
    colors = [
...
# Doom-One
def doomone() -> tuple[list[list[str]], str, str, str, str]:
    colors = [
...
def nord() -> tuple[list[list[str]], str, str, str, str]:
    colors = [
...
def gruvbox() -> tuple[list[list[str]], str, str, str, str]:
    colors = [
...
# Gruvbox Light
def gruvbox_light() -> tuple[list[list[str]], str, str, str, str]:
    colors = [
...
def catppuccin() -> tuple[list[list[str]], str, str, str, str]:
    colors = [
...
def moonfly() -> tuple[list[list[str]], str, str, str, str]:
    colors = [
...
def retro() -> tuple[list[list[str]], str, str, str, str]:
    colors = [
...
def whitey() -> tuple[list[list[str]], str, str, str, str]:
    colors = [
...
def fraggle() -> tuple[list[list[str]], str, str, str, str]:
    colors = [
...
def monokai() -> tuple[list[list[str]], str, str, str, str]:
    colors = [
